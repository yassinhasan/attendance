...
// $data['load_data']  =  toLink("admin/supervisorsgroups/realtime");
...
//$data['edit_data']  =  toLink("admin/supervisorsgroups/edit/");
...
add_new_btn.addEventListener("click",()=>
{
    ...
    $('#supervisorsgroupmodel').modal('toggle');
})
        ...
        .then(data=>
            {
                ...
                if(data.db_error)
                {
                    ...
                    {
                        document.querySelector(".supervisors-id").classList.add("alert" , "alert-danger");
                        document.querySelector(".supervisors-id").innerHTML = data.db_error;
                    }
                    removespinner()
                }
            }) 
...
//     == http://www.attendance.com/admin/supervisorsgroups/edit/1
let edit_url; 
function edit(el)
{
    el.forEach(element => {
